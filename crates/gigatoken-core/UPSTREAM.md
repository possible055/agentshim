...
- Replacement reproducible corpus: the first 246,384 UTF-8 bytes of
  `crates/pdf-read-core/src/content/parser.rs` followed by repeated `README.md`;
  `tiktoken==0.12.0` ordinary count: 57,475.
