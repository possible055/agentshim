...
mod tests {
    ...
    fn test_reading_order_info_convenience_constructors() {
        ...
        assert_eq!(
            ReadingOrderInfo::geometric().source,
            ReadingOrderSource::Geometric
        );
        assert_eq!(
            ReadingOrderInfo::simple().source,
            ReadingOrderSource::Simple
        );
        assert_eq!(
            ReadingOrderInfo::fallback().source,
            ReadingOrderSource::Fallback
        );
    }
