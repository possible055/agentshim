...
pub const GITIGNORE_RETRY_HINT: &str =
...
pub const UNDECODABLE_RETRY_HINT: &str =
...
impl SkipReason {
    ...
    #[must_use]
    pub const fn single_file_message(self) -> &'static str {
        match self {
...
impl SkipNotes {
    ...
    #[must_use]
    pub fn sampled(&self) -> &[SkipEntry] {
        &self.entries
    }

    #[must_use]
    pub fn terminal(&self, scan_complete: bool, noun: &str) -> Option<String> {
        if self.total == 0 {
            return None;
        }
