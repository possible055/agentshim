...
pub const MAX_IMAGE_PAGES: usize = 4;
...
pub struct PdfContinuation {
    pages: String,
    text_offset: Option<usize>,
}

pub struct PdfRetryRequest {
    mode: PdfMode,
    pages: String,
}
...
pub fn has_pdf_header(prefix: &[u8]) -> bool {
...
pub fn has_pdf_parameters(request: &ReadRequest) -> bool {
...
pub fn parse_page_selector(selector: &str) -> Result<(usize, usize), ReadError> {
