...
impl CandidateCollection {
    ...
    pub fn into_set(self, traversal: TraversalSummary, single_file: bool) -> CandidateSet {
...
pub fn candidate(path: ResolvedPath) -> Result<Candidate, GrepError> {
    path.absolute()
        .to_str()
