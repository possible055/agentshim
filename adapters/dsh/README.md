...
- The DSH `0.1.5-alpha.1` through `0.1.6-alpha.2` package families. Development and CI use DSH `0.1.6-alpha.2` with Cordis `4.0.2`; the peer declaration retains the supported historical DSH releases.
