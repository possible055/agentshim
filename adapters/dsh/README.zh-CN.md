...
- 支持的 DSH 套件家族包括 `0.1.5-alpha.1`、`0.1.5-alpha.2`、`0.1.5-rc.1`、`0.1.5-rc.2`、`0.1.6-alpha.1`、`0.1.6-alpha.2`、`0.1.7-alpha.1`、`0.1.7-alpha.2` 和 `0.1.7-rc.1`。开发与 CI 使用 DSH `0.1.7-rc.1` 及 Cordis `4.0.4`；peer 声明仍保留受支持的既有 DSH 版本。
