...
pub(super) struct PdfCursor<'a> {
    pub(super) source_id: &'a str,
    pub(super) text_offset: Option<usize>,
}

pub(super) fn encode(source_id: &str, text_offset: Option<usize>) -> String {
    match text_offset {
...
pub(super) fn decode(cursor: &str) -> Result<PdfCursor<'_>, ReadError> {
